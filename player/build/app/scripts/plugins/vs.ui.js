...
define('text!styles/main.css',[],function () { return '.character-count.hidden{display:none}\n.character-count{display:visible}\n.character-count-over{color:#f00}\n';});

(function() {
  var __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; };

  define('editable_text',["text!styles/main.css"], function(style) {
    ...
    return EditableText = (function() {
      ...
      function EditableText(options) {
        ...
        this.$el.addClass("vs-ui-editable-text");
        this._isEditing = false;
        if (this.options.charCount) {
          this.attachCharacterCount(this.options.charCount);
        }
      ...
      EditableText.prototype.onKeyPress = function(e) {
        var ev, length, printable;
        ev = e.originalEvent;
        printable = !!(ev.char || (ev.charCode && String.fromCharCode(ev.charCode)));
        length = this.getPretty().length;
        if (this.options.maxlength && length >= this.options.maxlength && printable) {
      ...
      EditableText.prototype.onKeyUp = function(e) {
        ...
        if (!(length || e.keyCode === 13)) {
          this.$el.empty();
        }
        return this.setCurrentCount(length);
      };

      EditableText.prototype.onBlur = function() {
        this.success();
        return this.hideCharCount();
      };

      EditableText.prototype.onFocus = function() {
        return this.showCharCount();
      };

      EditableText.prototype.selectText = function() {
        var _this = this;
      ...
      EditableText.prototype.toggleEdit = function(force, selectText) {
        var bool,
          _this = this;
        if (selectText == null) {
          selectText = true;
      ...
      EditableText.prototype.attachCharacterCount = function(count) {
        var template;
        this.count = count;
        template = '<div class="character-count pull-right">' + this.getPretty().length + '/' + this.count + '</div>';
        this.charCount = $(template);
        return this.$el.after(this.charCount);
      };

      EditableText.prototype.setCurrentCount = function(length) {
        if (this.charCount) {
          this.charCount.text(length + "/" + this.count);
          if (length > this.count && !this._errorSet) {
            this._errorSet = true;
            return this.charCount.addClass("character-count-over");
          } else if (length <= this.count && this._errorSet) {
            this._errorSet = false;
            return this.charCount.removeClass("character-count-over");
          }
        }
      };

      EditableText.prototype.showCharCount = function() {
        if (this.charCount) {
          return this.charCount.removeClass('hidden');
        }
      };

      EditableText.prototype.hideCharCount = function() {
        if (this.charCount) {
          return this.charCount.addClass('hidden');
        }
      };
      ...
      EditableText.prototype.success = function() {
        this.options.success(this.getPretty());
...
(function() {
  ...
  define('loading_indicator',["spin"], function(Spinner) {
    var LoadingIndicator;
    return LoadingIndicator = (function() {

      function LoadingIndicator(el, color) {
        var opts;
        if (color == null) {
          color = '#000';
        }
...
define("libs/jquery.nicescroll.min", function(){});

(function() {

  define('scroll',["libs/jquery.nicescroll.min"], function(NiceScroll) {
    var Scroll;
    return Scroll = (function() {
      ...
      function Scroll($el, options) {
        ...
        if (!options.allBrowsers) {
          options.userAgent || (options.userAgent = /Windows\ NT/);
          if (!navigator.userAgent.match(options.userAgent)) {
            return false;
          }
        }
        opts = {
      ...
      Scroll.prototype.resize = function() {
        return this.nice.resize();
      };

      Scroll.prototype.destroy = function() {
        return this.nice.hide();
      };
...
(function() {
  ...
  define('ui',['editable_text', 'loading', 'loading_indicator', 'scroll'], function(EditableText, Loading, LoadingIndicator, Scroll) {
    this.vs || (this.vs = {});
    return this.vs.ui = {
