...
define('models/course_revision',['require','exports','module','backbone','underscore'],function (require, exports, module) {(function() {
  ...
  CourseRevision = (function(_super) {
    ...
    CourseRevision.prototype.urlRoot = function() {
      if (this.course) {
        return _.result(this.course, 'url') + '/revisions';
      } else if (this.catalog) {
        return _.result(this.catalog, 'url') + '/courses';
      }
    };
...
define('collections/course_revisions',['require','exports','module','backbone','underscore','../models/course_revision'],function (require, exports, module) {(function() {
  ...
  CourseRevisions = (function(_super) {
    ...
    CourseRevisions.prototype.url = function() {
      if (this.course) {
        return _.result(this.course, 'url') + '/revisions';
      } else if (this.catalog) {
        return _.result(this.catalog, 'url') + '/courses';
...
define('models/catalog',['require','exports','module','backbone','../collections/course_revisions'],function (require, exports, module) {(function() {
  var Backbone, Catalog, CourseRevisions,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
define('models/lesson',['require','exports','module','backbone','underscore','../collections/gadgets'],function (require, exports, module) {(function() {
  ...
  Lesson = (function(_super) {
    ...
    function Lesson(attrs, options) {
      ...
      options.parse = true;
      Lesson.__super__.constructor.apply(this, arguments);
    }
...
define('models/course_progress',['require','exports','module','backbone'],function (require, exports, module) {(function() {
  ...
  CourseProgress = (function(_super) {
    ...
    CourseProgress.prototype.initialize = function(data, options) {
      if (!(options != null ? options.course : void 0)) {
        throw new Error('course should be provided to create a course progress');
      }
      return this.course = options.course;
    };
...
define('models/course_head',['require','exports','module','./course_revision','underscore'],function (require, exports, module) {(function() {
  ...
  CourseHead = (function(_super) {
    ...
    CourseHead.prototype.url = function() {
      return _.result(this.course, 'url') + '/head';
    };
...
define('models/course',['require','exports','module','backbone','underscore','../collections/lessons','../collections/users','./course_progress','../collections/course_revisions','./course_head'],function (require, exports, module) {(function() {
  var Backbone, Course, CourseHead, CourseProgress, CourseRevisions, Lessons, Users, _,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
  ...
  Course = (function(_super) {
    ...
    Course.prototype.isStaged = function() {
      return this.get('catalogs').indexOf('staged') !== -1;
    };
...
define('models/gadget_project',['require','exports','module','backbone','underscore'],function (require, exports, module) {(function() {
  ...
  GadgetProject = (function(_super) {
    ...
    GadgetProject.prototype.defaults = {
      author: 'Versal Group'
    };
    ...
    GadgetProject.prototype.parse = function(attrs, options) {
      ...
      this.icon = attrs.files['assets/icon.png'];
      return attrs;
    };
...
define('api',['require','exports','module','backbone','jquery','underscore','./helpers/backbone_collection_move','./models/asset','./collections/assets','./models/asset_representation','./collections/asset_representations','./models/catalog','./collections/catalogs','./models/course','./collections/courses','./models/course_head','./models/course_progress','./models/course_revision','./collections/course_revisions','./collections/courses','./models/gadget','./collections/gadgets','./models/gadget_project','./collections/gadget_projects','./collections/gadget_userstates','./models/lesson','./collections/lessons','./models/partnerkey','./models/tag','./collections/tags','./models/user','./collections/users','./models/gadget','./api_errors','./adapters/node','./adapters/browser'],function (require, exports, module) {(function() {
  var Backbone, api, _;
  ...
  module.exports = api = {
    ...
    connect: function(options) {
      ...
      this.sessionIdKey = options.sessionIdKey || this.sessionIdKey;
      this.sessionId = options.sessionId;
      this.Asset.prototype.baseUrl = this.apiUrl;
      return this.GadgetProject.prototype.baseUrl = this.apiUrl;
    },
