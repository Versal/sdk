define(['cdn.jquery','cdn.backbone'], function(){ var cdn = {}; cdn.jquery = arguments[0];cdn.backbone = arguments[1];
/**
...
define("../../sdk/lib/sdk/almond", function(){});

define('scripts/random',[], function(){
  return function(){
    return Math.floor(Math.random() * 100) + 1;
  }
});
define('gadget',["scripts/random", "cdn.jquery", "cdn.backbone"], function(random, $, Backbone){
