...
define('models/course',['require','exports','module','backbone','underscore','../collections/lessons','../collections/users','./course_progress'],function (require, exports, module) {(function() {
  var Backbone, Course, CourseProgress, Lessons, Users, _,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
  ...
  Course = (function(_super) {
    ...
    Course.prototype.parse = function(attrs) {
      ...
      if (attrs.authors) {
        this.authors.reset(attrs.authors, {
          parse: true
        });
      }
      return _.omit(attrs, 'lessons', 'authors');
    };
...
define('text!gadgets/section/template.html',[],function () { return '<div class=\'section-content\'></div>\n<div class=\'section-fadeout\'></div>\n';});
  ...
  define('gadgets/section/gadget',['text!./template.html'], function(template) {
    ...
    return SectionHeader = (function() {
      ...
      SectionHeader.prototype.finishEditing = function() {
        ...
        this.save();
        return this.facade.trigger('cancelEditing');
      };
...
(function() {
  ...
  define('messages/handlers/parent_notify',[], function() {
    return function(data) {
      return window.top.postMessage(JSON.stringify(data), '*');
    };
  });
...
(function() {
  ...
  define('app/mediator',['messages/mediator', 'messages/handlers/asset_select', 'messages/handlers/style_register', 'messages/handlers/inline_catalogue_show', 'messages/handlers/parent_notify'], function(Mediator, assetSelectHandler, styleRegisterHandler, inlineCatalogueHandler, parentNotifyHandler) {
...
(function() {
  ...
  define('messages/facade',['cdn.backbone', 'app/mediator'], function(Backbone, mediator) {
    var Facade, locals;
    locals = ['change', 'configure', 'configChange', 'doneEditing', 'domReady', 'save', 'toggleEdit', 'registerPropertySheet', 'render', 'cancelEditing'];
...
define("cdn.jqueryui.legacy", ["cdn.jquery"], (function (global) {
    return function () {
        var ret, fn;
        return ret || global.$;
    };
...
(function() {
  ...
  define('views/lesson',['cdn.marionette', 'app/mediator', 'views/gadget_instance', 'views/inline_catalogue', 'app/catalogue', 'plugins/vs-sticky', 'cdn.jqueryui.legacy'], function(Marionette, mediator, GadgetInstanceView, InlineCatalogueView, gadgetCatalogue, VsSticky) {
    var Lesson;
    ...
    return Lesson = (function(_super) {
      ...
      Lesson.prototype.fixSizing = function() {
        ...
        return _.defer(function() {
          return _this.$el.css({
            "min-height": $(window).height() - $('.courseHeader').height() - $('.nav').height() - 5
          });
        });
      };
...
(function() {
  ...
  define('views/../../toc/main',["cdn.jquery", "cdn.marionette", "text!./student.html", "text!./author.html", "cdn.jqueryui.legacy", "app/mediator"], function($, Marionette, studentTemplate, authorTemplate, jqueryUI, mediator) {
...
(function() {
  ...
  define('views/nav_buttons',['cdn.marionette', 'text!templates/nav-buttons.html', 'app/mediator'], function(Marionette, template, mediator) {
    var NavButtonsView;
    return NavButtonsView = (function(_super) {
      ...
      NavButtonsView.prototype.initialize = function() {
        ...
        return mediator.on('blocking:changed', this.render, this);
      };

      NavButtonsView.prototype.onClose = function() {
        mediator.off('lesson:rendered', this.updateButtons);
        return mediator.off('blocking:changed', this.render);
      };
      ...
      NavButtonsView.prototype.onPreviousClick = function() {
        return mediator.trigger('lesson:navigate', 1 + this.model.lessons.indexOf(this.prev));
      };

      NavButtonsView.prototype.onNextClick = function() {
        return mediator.trigger('lesson:navigate', 1 + this.model.lessons.indexOf(this.next));
      };
...
(function() {
  ...
  define('views/course',['cdn.marionette', 'text!templates/course.html', 'views/lesson', 'app/mediator', '../../toc/main', 'views/nav_buttons'], function(Marionette, template, LessonView, mediator, TOCView, NavButtonsView) {
    var Course;
    return Course = (function(_super) {
      ...
      Course.prototype.onRender = function() {
        ...
        this.toc.ready = true;
        return this.nav.show(new NavButtonsView({
          model: this.model
        }));
      };
...
(function() {
  ...
  define('views/sidebar/author/gadget',['cdn.marionette', 'text!templates/author_sidebar/sidebar_gadget.html'], function(Marionette, template) {
    var SidebarGadget;
...
(function() {
  ...
  define('views/sidebar/author/catalogue',['cdn.marionette', 'text!templates/author_sidebar/catalogue.html', './gadget', 'app/catalogue', 'plugins/backbone.filter'], function(Marionette, template, GadgetCard, gadgetCatalogue) {
...
(function() {
  ...
  define('views/sidebar/learner',['cdn.marionette', 'text!templates/learner_sidebar.html', 'text!templates/learner_sidebar_item.html', 'app/mediator', './sidebar'], function(Marionette, template, itemTemplate, mediator, Sidebar) {
    ...
    return LearnerSidebar = (function(_super) {
      ...
      LearnerSidebar.prototype.selectLesson = function(lessonView) {
        ...
        return mediator.trigger('lesson:navigate', this.model.lessons.indexOf(lesson) + 1);
      };

      LearnerSidebar.prototype.updateActiveLesson = function(view) {
        var lesson;
        lesson = view.model;
...
(function() {
  ...
  define('views/sidebar/sidebar',['app/mediator', './learner', './author/author'], function(mediator, LearnerView, AuthorView) {
    var mixins;
    return mixins = {
...
(function() {
  ...
  define('player',['cdn.marionette', 'views/course', 'views/sidebar/author/author', 'views/sidebar/learner', 'app/catalogue', 'text!templates/player.html', 'text!templates/loading.html', 'app/mediator'], function(Marionette, CourseView, AuthorSidebarView, LearnerSidebarView, gadgetCatalogue, template, loadingTemplate, mediator) {
    ...
    return PlayerApplication = (function() {
      ...
      PlayerApplication.prototype.onCourseLoad = function(courseModel) {
        this._loading.done();
        if (this.options.noEditable || this.isLearner) {
          courseModel.set({
            isEditable: false
          });
        }
        ...
        courseModel.whitelabel = this.options.whitelabel;
