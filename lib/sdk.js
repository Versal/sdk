...
sdk.configuration = {
  apiUrl: "http://testing.vrsl.net/api2/",
...
sdk.wrapCode = function(code, deps) {
  ...
  //TODO: Validate, if return require('gadget') works.
...
sdk.preview = function(argv){
  ...
  sdk.compile({}, function (err) {

    var app = connect()
      .use(require('./player-bridge'))
    ...
    //  require("open")(url); // Most. Annoying. Utility. Ever. Let's never use it again.
  });
};
