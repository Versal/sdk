...
validator.requiredFiles = ["manifest.json", "assets/icon.png", "gadget.js", "gadget.css"];

// Validates folder with compiled gadget.
// Returns array of errors
validator.validateFolder = function(gadgetPath) {
  var manifestPath = path.join(gadgetPath, "manifest.json");

  if(!fs.existsSync(manifestPath)) {
    return ["Manifest.json is not found! Cannot continue."];
  }
