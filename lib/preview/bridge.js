(function() {
  var Bridge, defaults, express, fs, glob, path, sdkFixtures, sdkSite, shortid, _;
  ...
  module.exports = Bridge = (function() {
    function Bridge(options) {
      ...
      api.post('/courses/:id/lessons', function() {
        return res.send(201);
      });
      api.put('/courses/:id/lessons/:lesson_id', function() {
        return res.send(200);
      });
      api["delete"]('/courses/:id/lessons/:lesson_id', function() {
        return res.send(200);
      });
      api.post('/courses/:id/lessons/:lesson_id/gadgets', function() {
        return res.send(201);
      });
      api.put('/courses/:id/lessons/:lesson_id/gadgets/:gadget_id', function() {
        return res.send(200);
      });
      api["delete"]('/courses/:id/lessons/:lesson_id/gadgets/:gadget_id', function() {
        return res.send(200);
      });
      api.put('/courses/:id/lessons/:lesson_id/gadgets/:gadget_id/config', function() {
        return res.send(200);
      });
      api.put('/courses/:id/lessons/:lesson_id/gadgets/:gadget_id/userstate', function() {
        return res.send(200);
      });
