(function() {
  var async, fs, ncp, path, requirejs, _;
  ...
  module.exports = {
    command: function(dir, options, callback) {
      ...
      config = {
        ...
        out: function(code) {
          return _this.createBundle(code, src, bundlePath, callback);
        }
      };
    ...
    createBundle: function(code, src, bundlePath, callback) {
      ...
      fs.writeFileSync("" + bundlePath + "/gadget.js", this.wrap(code));
      return this.copyFiles(src, bundlePath, callback);
    },
    wrap: function(code) {
      var deps;
      code = this.wrapInAlmond(code);
      deps = this.extractDeps(code);
      code = this.wrapDeps(code, deps);
      return code;
    },
