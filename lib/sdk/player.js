...
(function() {
  ...
  define('views/lesson',['cdn.marionette', 'app/mediator', 'views/gadget_instance', 'views/inline_catalogue', 'app/catalogue', 'plugins/vs-sticky', 'cdn.jqueryui'], function(Marionette, mediator, GadgetInstanceView, InlineCatalogueView, gadgetCatalogue, VsSticky) {
    var Lesson;
